...
public class Client {
    ...
    @Size(min = 2, max = 10, message = "Имя не может быть меньше 2х и больше 10 символов")
    private String name;

    @NotEmpty(message = "поле - \"Фамилия\" не должно быть пустым")
    @Size(min = 2, max = 15, message = "Фамилия не может быть меньше 2х и больше 15 символов")
