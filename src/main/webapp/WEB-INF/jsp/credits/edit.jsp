...
<body>
<form th:method="PATCH" th:action="@{/credits/{id}(id=${credit.getId()})}" th:object="${credit}">
    <br/>
    <input type="text" th:field="*{interestRate}" id="interestRate"/>
    <p style="color: red" th:if="${#fields.hasErrors('interestRate')}" th:errors="*{interestRate}">Error name</p>
    <br/>
