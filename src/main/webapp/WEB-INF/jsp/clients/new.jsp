...
<form th:method="POST" th:action="@{/clients}" th:object="${client}">
    ...
    <p style="color: red" th:if="${#fields.hasErrors('telephoneNumber')}" th:errors="*{telephoneNumber}">Error telephone
        number</p>
    <br/>
    ...
    <p style="color: red" th:if="${#fields.hasErrors('passportNumber')}" th:errors="*{passportNumber}">Error passport
        number</p>
    <br/>
